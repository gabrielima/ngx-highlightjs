...
import { InjectionToken, makeEnvironmentProviders, inject, DOCUMENT, PLATFORM_ID, Injectable, signal, computed, ElementRef, afterRenderEffect, SecurityContext, Directive, input, booleanAttribute, output, NgModule } from '@angular/core';
...
class HighlightLoader {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightLoader, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightLoader, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightLoader, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class HighlightJS {
    constructor() {
        ...
        this.options = inject(HIGHLIGHT_OPTIONS, { optional: true });
        this.hljsSignal = signal(null, ...(ngDevMode ? [{ debugName: "hljsSignal" }] : []));
        this.hljs = computed(() => this.hljsSignal(), ...(ngDevMode ? [{ debugName: "hljs" }] : []));
     ...
     */
    async registerAliases(alias, { languageName }) {
        const hljs = await this.loader.ready;
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightJS, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightJS, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightJS, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
function _resetTrustedTypesPolicyForTests() {
    policy = undefined;
}
...
class HighlightBase {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightBase, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.7", type: HighlightBase, isStandalone: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightBase, decorators: [{
            type: Directive
        }], ctorParameters: () => [] });
...
class Highlight extends HighlightBase {
    constructor() {
        super(...arguments);
        // Code to highlight
        this.code = input(null, { ...(ngDevMode ? { debugName: "code" } : {}), alias: 'highlight' });
        // Highlighted result
        this.highlightResult = signal(null, ...(ngDevMode ? [{ debugName: "highlightResult" }] : []));
        // The language name highlight only one language.
        this.language = input.required(...(ngDevMode ? [{ debugName: "language" }] : []));
        ...
        this.ignoreIllegals = input(undefined, { ...(ngDevMode ? { debugName: "ignoreIllegals" } : {}), transform: booleanAttribute });
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: Highlight, deps: null, target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.0.7", type: Highlight, isStandalone: true, selector: "[highlight]", inputs: { code: { classPropertyName: "code", publicName: "highlight", isSignal: true, isRequired: false, transformFunction: null }, language: { classPropertyName: "language", publicName: "language", isSignal: true, isRequired: true, transformFunction: null }, ignoreIllegals: { classPropertyName: "ignoreIllegals", publicName: "ignoreIllegals", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { highlighted: "highlighted" }, host: { properties: { "class.hljs": "true" } }, providers: [{ provide: HighlightBase, useExisting: Highlight }], usesInheritance: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: Highlight, decorators: [{
            type: Directive,
            args: [{
                    selector: '[highlight]',
        ...
        }], propDecorators: { code: [{ type: i0.Input, args: [{ isSignal: true, alias: "highlight", required: false }] }], language: [{ type: i0.Input, args: [{ isSignal: true, alias: "language", required: true }] }], ignoreIllegals: [{ type: i0.Input, args: [{ isSignal: true, alias: "ignoreIllegals", required: false }] }], highlighted: [{ type: i0.Output, args: ["highlighted"] }] } });

class HighlightAuto extends HighlightBase {
    constructor() {
        super(...arguments);
        // Code to highlight
        this.code = input(null, { ...(ngDevMode ? { debugName: "code" } : {}), alias: 'highlightAuto' });
        // Highlighted result
        this.highlightResult = signal(null, ...(ngDevMode ? [{ debugName: "highlightResult" }] : []));
        // An optional array of language names and aliases restricting detection to only those languages.
        // The subset can also be set with configure, but the local parameter overrides the option if set.
        this.languages = input(...(ngDevMode ? [undefined, { debugName: "languages" }] : []));
        // Stream that emits when code string is highlighted
        this.highlighted = output();
    }
    async highlightElement(code) {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightAuto, deps: null, target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.0.7", type: HighlightAuto, isStandalone: true, selector: "[highlightAuto]", inputs: { code: { classPropertyName: "code", publicName: "highlightAuto", isSignal: true, isRequired: false, transformFunction: null }, languages: { classPropertyName: "languages", publicName: "languages", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { highlighted: "highlighted" }, host: { properties: { "class.hljs": "true" } }, providers: [{ provide: HighlightBase, useExisting: HighlightAuto }], usesInheritance: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightAuto, decorators: [{
            type: Directive,
            args: [{
        ...
        }], propDecorators: { code: [{ type: i0.Input, args: [{ isSignal: true, alias: "highlightAuto", required: false }] }], languages: [{ type: i0.Input, args: [{ isSignal: true, alias: "languages", required: false }] }], highlighted: [{ type: i0.Output, args: ["highlighted"] }] } });

class HighlightModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.7", ngImport: i0, type: HighlightModule, imports: [Highlight, HighlightAuto], exports: [Highlight, HighlightAuto] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightModule, decorators: [{
            type: NgModule,
            args: [{
