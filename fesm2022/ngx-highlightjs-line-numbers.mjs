...
class HighlightLineNumbers {
    constructor() {
        ...
        this.startFrom = input(this.options?.startFrom, { ...(ngDevMode ? { debugName: "startFrom" } : {}), transform: numberAttribute });
        this.singleLine = input(this.options?.singleLine, { ...(ngDevMode ? { debugName: "singleLine" } : {}), transform: booleanAttribute });
        afterRenderEffect({
            write: () => {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightLineNumbers, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.0.7", type: HighlightLineNumbers, isStandalone: true, selector: "[highlight][lineNumbers], [highlightAuto][lineNumbers]", inputs: { startFrom: { classPropertyName: "startFrom", publicName: "startFrom", isSignal: true, isRequired: false, transformFunction: null }, singleLine: { classPropertyName: "singleLine", publicName: "singleLine", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: HighlightLineNumbers, decorators: [{
            type: Directive,
            args: [{
                    selector: '[highlight][lineNumbers], [highlightAuto][lineNumbers]'
                }]
        }], ctorParameters: () => [], propDecorators: { startFrom: [{ type: i0.Input, args: [{ isSignal: true, alias: "startFrom", required: false }] }], singleLine: [{ type: i0.Input, args: [{ isSignal: true, alias: "singleLine", required: false }] }] } });
